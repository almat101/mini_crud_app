import { generateJwtToken, hashPassword, comparePasswords, validateJwtPayload, validateUserCredentials, validateSignupData } from "../services/authService.js";
...
describe('Unit test per validateUserCredentials', () => {
    test('Should validate a user with valid credential and return the user object', async () => {
        ...
        expect(result).toStrictEqual({ email : 'alex@gmail.com', password : 'test2Ciao3'})
    })
    ...
    test('Should not validate a user with invalid credential and throw a specific error', async () => {
        ...
        //Act Assert
        await expect(validateUserCredentials(invalid_email_login)).rejects.toThrow("Invalid login data. Please check your input.");
    })
    ...
    test('Should not validate a user with empty email', async () => {
        ...
        //Act Assert
        await expect(validateUserCredentials(empty_email_login)).rejects.toThrow("Invalid login data. Please check your input.");
    })
        ...
        //Act Assert
        await expect(validateUserCredentials(empty_password_login)).rejects.toThrow("Invalid login data. Please check your input.");
    })
})
...
describe("Unit test for validateSignupData" , () => {
    ...
    test("Should not validate a user with passwords that do not match", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_wrong_password)).rejects.toThrow("Invalid signup data. Please check your input.")
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_email)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
    ...
    test("Should not validate a user with invalid username", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_username)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
    ...
    test("Should not validate a user with empty username", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_empty_username)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
    ...
    test("Should not validate a user with empty password", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_empty_password)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
    ...
    test("Should not validate a user with empty email", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_empty_email)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
    ...
    test("Should not validate a user with all field empty", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_empty)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
    ...
    test("Should not validate a user with numerical(int) name", async () => {
        ...
        // act e assert
        await expect(validateSignupData(invalid_user_signup_int_username)).rejects.toThrow("Invalid signup data. Please check your input.")
    })
})
