...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const prev_query = await executePrevQuery(validateUser.username , validateUser.email)
        ...
        const result = await createUser(validateUser.username, validateUser.email, hash) 
...
export const login = async (req, res) => {
    ...
    try {
        ...
        const compared_password = await comparePasswords(validateUserLogin.password, userFound.password_hash);
